...
if "LIFETRACKER_SECRET_KEY_FILE" not in os.environ and not _key_file.exists():
    ...
    try:
        _old_stored = (
            _old_key_file.read_text(encoding="utf-8").strip()
    ...
    if _old_stored:
        try:
            ...
            _key_file.write_text(_old_stored + "\n", encoding="utf-8")
...
try:
    ...
    raise RuntimeError(
        ...
        "Check file permissions or set LIFETRACKER_SECRET_KEY_FILE to a readable path."
    ) from _e
...
if not _stored:
    ...
    try:
        ...
        raise RuntimeError(
            ...
            "Check directory permissions or set LIFETRACKER_SECRET_KEY_FILE "
            "to a writable path."
        ) from _e
